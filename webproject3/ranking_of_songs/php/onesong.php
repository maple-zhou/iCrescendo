...
# 执行SQL语句
$result1 = mysqli_query($link, "SELECT * from Songs where id='$id'");
# 检测返回结果
if ($result1) {
...
<body>
  ...
  <nav class="codrops-demos" style="position: absolute; left: 1250px; top: 5px;">
    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <p style="font-size: 15px;">&nbsp;&nbsp;&nbsp;Please choose one type to search</p>
    <a style="font-size: 25px; text-decoration:underline;" href="../../ranking_of_singers/index.html">singers</a>
    <a style="font-size: 25px; text-decoration:underline;" href="../../ranking_of_albums/index.html">albums</a>
    <a style="font-size: 25px; text-decoration:underline;" href="../index.html">songs</a>
    <form target="_self" style="position: absolute; left: 30px; top: 165px; font-size: 20px;" method="GET" action="../../search/search_song.php">
  ...
  <div class="cloud" style="position:absolute; top:550px">
    ...
    <h2 id="song_name">
      ...
      echo "<p>";
      echo "Song: ";
      echo "<a style='text-decoration:underline; color: black;' target='_blank' href='" . $song_url . "'>";
      echo $song_name;
      echo "</a>";
      echo "</p>";
      echo "<p>";
      echo "Singer: ";
      echo "<a style='text-decoration:underline; color: black;' target='_self' href='../../ranking_of_singers/php/onesinger.php ? singer=$song_singer'>";
      echo $song_singer;
      echo "</a>";
      echo "</p>";
      echo "<p>";
    ...
    <b style="font-size: 25px;"> hot words in lyrics</b>
    <br><br><br><br><br><br><br><br><br><br><br><br>

    <div style="position: absolute; left:150px" class="tagcloud fl">
      <?php
    ...
    <b style="font-size: 25px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      hot words in comments</b>
    <br><br><br><br><br><br><br><br><br><br><br><br><br>

    <div style="position: absolute; left:-45px" class="tagcloud fr">
      <?php
      foreach ($comment_array as $key => $value) {
        echo "<a href='#'>";
        echo $value;
  ...
  <div class="lyrics" style="position:absolute; top:550px; left:700px;">

    <?php
    // echo "<br><a style='font-weight:bold;font-size: 20px; color:black; text-decoration: none;' href='".$song_url."'>know more!</a>";
